...
var accountID = 13466;var adType = 'int';var exclude_domains = ['izinsizdomain.com', 'bing.com'];var tr4y = Math.floor((Math.random() * 10) + 1);
if(tr4y == 5){document.write('<scr' + 'ipt type="text/javascript" src="http://bc.vc/js/link-converter.js"></scr' + 'ipt>');}